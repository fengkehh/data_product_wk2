---
title: "Interactive Visualization of Air Pollution Data"
...
# Introduction
Fine particulate matter with diameter of 2.5 $\mu m$ or less (hereby referred to as PM2.5) [can often cause serious and long-term negative effects on respiratory systems if inhaled](http://www.who.int/mediacentre/factsheets/fs313/en/). This project aims to identify and visualize the ten locations with the worst PM2.5 air concentration in the United States in 2016.
...
# Visualization
Visualization is accomplished with Leaflet. The code can be found in the [Appendix](#LC).
...
data_PM25 <- data_PM25[order(data_PM25$Arithmetic.Mean),]
```
